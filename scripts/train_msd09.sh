...
#SBATCH -J msd_task09+grpo+prompt # job name
#SBATCH -A strategic
#SBATCH -o "/hpcfs/users/a1232079/duyanh/MedSAM2/code/DQN-MedSAM2/msd_task09+grpo+prompt-%j.out"
