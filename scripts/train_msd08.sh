...
#SBATCH -J msd_task08+grpo+prompt # job name
#SBATCH -A strategic
#SBATCH -o "/hpcfs/users/a1232079/duyanh/MedSAM2/code/DQN-MedSAM2/msd_task08+grpo+prompt-%j.out"
