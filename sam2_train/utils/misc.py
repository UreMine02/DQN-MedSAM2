...
def similarity_score(current_vision_feats, previous_vision_feats):
    current_vision_feats = current_vision_feats[-1][:, 0:1]
    score = torch.dot(current_vision_feats.flatten(), previous_vision_feats.flatten())
    return score